...
$events = $pdo->query("SELECT e.* FROM events e JOIN categories c ON e.category_id = c.category_id WHERE c.category_name = 'Social'")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Social Events - StreetWave</title>
